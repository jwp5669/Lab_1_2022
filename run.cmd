...
call conda activate physiological-data-collection
if errorlevel 1 (
   echo.
   echo Creating conda environment on first-time use...
   call conda env create -n physiological-data-collection -f conda-environment.yml
)

echo updating environment...
call conda env update -n physiological-data-collection -f conda-environment.yml
echo Launching application...
call conda activate physiological-data-collection && python main.py %*
